...
class Mail:
    def __init__(self,root):
        ...
        email_label = Label(self.root, text="Enter receiver's Email: ", font=("ariel 15 bold"),fg='white',bg='black', relief=FLAT)
    ...
    def send(self):
        try: 
            ...
            register = "Your ID is "+str(register)
            #otp="Your Student Registeration ID is:"+register1
            #msg=otp
